...
#ifndef HC256_CIPHER_H 
#define HC256_CIPHER_H
...
void encrypt(uint32 data[],uint32 &counter2048,uint32 P[],uint32 X[],uint32 Q[],uint32 Y[]) //each time it encrypts 512-bit data
{
    uint32 cc,dd;
...
void initialization(uint32 key[],uint32 iv[],uint32 P[],uint32 Q[],uint32 &counter2048,uint32 X[],uint32 Y[])
{
    uint32 i,j;
